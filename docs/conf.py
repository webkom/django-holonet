...
copyright = u'2014, Abakus Webkom'
...
htmlhelp_basename = 'django-holonetdoc'
...
texinfo_documents = [
  ('index', 'django-holonet', u'django-holonet Documentation',
   u'Abakus Webkom', 'django-holonet', 'One line description of project.',
   'Miscellaneous'),
]
